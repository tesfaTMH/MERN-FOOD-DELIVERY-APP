    ...
    <div className="flex flex-col gap-12">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col items-center justify-center gap-4 text-center">
          ...
          <span>
            Download{" "}
            <span className="flex items-center border-2 rounded-2xl p-2 bg-slate-500">
              <span className="text-1xl text-orange-500 items-center">
                TMH{" "}
              </span>
              <p className=" text-amber-300">Resturant</p>
            </span>{" "}
            App
          </span>
          <img src={appDownload} />
